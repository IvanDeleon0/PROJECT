        ...
        if (initchoice == 1) {
            ...
            if(found){
                ...
                do{
                    ...
                    cout << string (30,' ') << blue << "-----------------------------" << reset << endl;
                    cout << string (30,' ') <<"\t1. Add Anime" << endl;
                    cout << string (30,' ') << "\t2. Add Manga" << endl;
                    cout << string (30,' ') << blue << "-----------------------------" << reset << endl;
                     cout << string (30,' ') << "\t3. Search " << reset << endl; 
                    cout << string (30,' ') << "\t4. Dashboard" << endl;
                    cout << string (30,' ') << "\t-----------------------------" << endl;
                    cout << string (30,' ') << red << "\t5. DELETE MANGA" << endl;
                    cout << string (30,' ') << "\t6. DELETE ANIME" << endl << reset;
                    cout << string (30,' ') << "\t-----------------------------" << endl;
                    cout << string (30,' ') << yellow << "\t7. LOG OUT" << endl <<reset;
                    cout << string (30,' ') <<blue << "-----------------------------" << reset << endl;
                    cout << string (30,' ') << green << "Choice: " << reset;
                    cin >> choice1;
...
void deleteManga(Account &acc) {
    ...
    cout << red << string(30,' ') << "============================\n";
    cout << string(30,' ') << "     DELETE MANGA MENU\n";
    cout << string(30,' ') << "============================\n" << reset;

    if (mangaTemp.empty()) {
        cout << string(30,' ') << "No manga to delete.\n";
        delay(2);
        return;
    }

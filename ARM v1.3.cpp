...
struct accContents{
  ...
  string anime_name;//  anime name is for the dashboard, so that we can display the anime name and episodes watched
  ...
  string manga_name; // manga name is for the dashboard, so that we can display the manga name and chapters read
          ...
          if(found){
              ...
              switch(choice1){
                  case 1: {
                        ...
                        cout << "Anime name: ";
                        getline(cin , temp.content.anime_name); 
                        cout << "Episodes Watched: ";
                        cin >> new_ep;
                        
                        temp.content.anime_ep += new_ep;
                  ...
                  case 2: {
                    cin.ignore(1000,'\n');   
                        ...
                        cout << "Manga name: ";
                        getline(cin,temp.content.manga_name); 
                        cout << "Chapters read: ";
                        cin >> new_chpt;
                        
                        temp.content.manga_chpt += new_chpt;
                        saveToFile(userAccount); 
                  ...
                  case 3: {
                        ...
                        cout <<yellow << "\n[ANIME]\n";
                        cout << "Anime Name                Total Episodes Watched"<<endl;
                        cout << left << setw(25)<<temp.content.anime_name << setw(15) << temp.content.anime_ep;
                        cout << "\n===============================================================";
                        
                        cout << "Press "<< yellow<<"Enter "<< reset<< "to go back to Menu";
                         cin.ignore(1000,'\n');
